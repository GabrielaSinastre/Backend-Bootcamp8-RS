...
class AvailableController {
  async index(req, res) {
    ...
    // todos os agendamentos disponiveis que o provider possui
    const schedule = [
      '08:00',
      '09:00',
      '10:00',
    ...
    // verificar se o horario ja passou o se não é um horario q ja esta agendado
    const available = schedule.map((time) => {
      ...
      return {
        ...
        // verificar se o value vai acontecer depois de agora
        available:
